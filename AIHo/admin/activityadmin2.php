    ...
    <div class="card text-center">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link" href="activityadmin.php">Covid-19</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="activityadmin2.php">Konsultasi</a>
                </li>
            </ul>
        </div>
            ...
            <table style="text-align: center" class="table table-striped">
                ...
                while($datacart = mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td><a href="updatekonsul.php?id=<?php echo $datacart['id']?>" class="btn btn-success">Update</a></td>
