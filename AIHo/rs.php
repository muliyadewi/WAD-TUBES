  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col">
                <h2 class="judul">
                    RUMAH SAKIT YANG TERSEDIA UNTUK KONSULTASI
                </h2>
            </div>
        </div>

    <div class="container mt-5">
        <div class="card mb-4 p-4" style="max-width: 1000px;">      
            ...
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  Buka 24 jam<p>
                  </p><img src="https://png.pngtree.com/png-vector/20200902/ourlarge/pngtree-rupiah-currency-in-the-form-of-silver-coins-png-image_2337469.jpg" class="card-img-top" alt="" style="width: 21px; height: 21px;">
                  1 jam 75.000</p>
                  <a href="Form Konsultasi.php" class="btn btn-primary">Next</a>
                </div>
              </div>
            </div>
            <div class="col">
            ...
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  Buka 24 jam<p>
                  </p><img src="https://png.pngtree.com/png-vector/20200902/ourlarge/pngtree-rupiah-currency-in-the-form-of-silver-coins-png-image_2337469.jpg" alt="" style="width: 21px; height: 21px;">
                  1 jam 60.000</p>
                  <a href="Form Konsultasi.php" class="btn btn-primary">Next</a>
                </div>
              </div>
