  ...
  <div class="container mt-5">
    <div class="card mb-4 p-4" style="max-width: 1000px; margin: auto;">
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
          <div class="card">
            <img src="https://1.bp.blogspot.com/-978U6PZbo6w/XfXt3viYWcI/AAAAAAAALoM/6lbfLQglA4E5UzLNUZz8Vg5KEaQjzrftgCLcBGAsYHQ/s1600/rs-al-islam-bandung-jawa-barat.jpg" class="card-img-top" alt="rsai" style="width: 299px; height: 250px;">
            <div class="card-body">
